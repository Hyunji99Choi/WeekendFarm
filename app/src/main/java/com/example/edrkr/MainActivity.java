...
public class MainActivity extends AppCompatActivity {
    ...
    private String UserData_URL="http://192.168.43.10:3000/users/main/";

    String UserID="ghd8119";
    String UserPW="1234";
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    case R.id.loginButton:
                        ...
                        Login_networkTask.execute();



                        while (true){
                            if(Login_networkTask.finish_Check==true)
                                break;
                        }


                        if(Login_networkTask.result=="성공"){
                            Log.w("로그인 시도","성공");
                            //쓰레드 문제 고민해보기
                        ...
                        }else if(Login_networkTask.result=="실패"){
                            Log.w("로그인 시도","잘못된 정보");
